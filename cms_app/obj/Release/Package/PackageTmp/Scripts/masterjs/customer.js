$(document).ready(function () {
    ...
    $("#btnSave,#btnUpdate").click(function () {
        ...
        if (action == 'INSERT') {
            ...
            var customerlist = $('#sltCompany option:selected').attr('data-child');
            if (customerlist.toUpperCase().split(',').indexOf(code) > -1) {
